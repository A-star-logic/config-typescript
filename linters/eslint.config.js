...
export default tseslint.config(
  ...
  // base config
  {
    ...
    rules: {
      ...
      // eslint
      //
      "max-params": [1, 1], // enforce named parameters with the use of objects
      camelcase: [
        2,
        {
          properties: "always",
      ...
      //
      "unicorn/no-null": 1, // to avoid today, and enforce whenever possible
      ...
      "unicorn/no-empty-file": 1, // to avoid today, and enforce whenever possible
  ...
  ////////////////////////
  {
    files: ["services/packages/vendors/**"],
    rules: {
      camelcase: 0, // too many divergences
    },
  },
  {
    files: ["**/*-callback.vue"],
  ...
  //////////////////
  {
    files: ["services/packages/server/**", "services/apps/api/**"],
    rules: {
      "max-params": 0,
  ...
  ///////////////
  {
    ...
    rules: {
      ...
      // enforce the order of attributes in SFC
      ...
      "no-undef": "off", // one of the not so nice things of nuxt, TS should handle this
    },
  },
  {
